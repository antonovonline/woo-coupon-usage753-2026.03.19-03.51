...
- Fix: Fixed a potential PHP error "access array offset on value of type null" in some cases.

= Version 6.3.4 - 22nd April 2025 =
- New: Added a new option to the "registration" settings to choose whether or not to automatically log the user in after registration.
- Tweak: Made a few small changes to the setup wizard to improve the user experience.
- Tweak: Made a few small "quality of life" tweaks and improvements to some admin pages in the plugin.
- Fix: Potential fix for the MLA option "Deduct parent affiliate commission from sub-affiliate commission".
- Other: Updated "Spanish" translations with reviewed and modified version.

= Version 6.3.3 - 15th April 2025 =
- Fix: Fixed a potential PHP fatal error in the PRO version.

= Version 6.3.2 - 14th April 2025 =
...
- Fix: Light mode will now be the selected mode by default on the affiliate portal.
- Fix: Fixed the alignment of the statistic boxes on the affiliate dashboard in some cases.

= Version 6.0.1 - 18th March 2025 =
- Tweak: Made a few small styling tweaks/fixes to the affiliate portal.
- Fix: Permalinks are now automatically flushed when enabling the "affiliate portal" feature. This should fix the page not showing correctly after enabling the feature.
- Fix: Fixed the logged out page on the new affiliate portal not showing the login and registration forms.
- Fix: Fixed the mobile menu icon showing on the affiliate portal when logged out.
- Fix: Fixed first time activation redirect not working in some cases.
- Fix: (PRO) Fixed an error with the "sub-affiliate summary" tab on the MLA dashboard.
- Fix: (PRO) Fixed an issue with the "sub-affiliate summary" tab not showing the "percentage of order total" amounts in the "your commission" column.
- Fix: (PRO) Fixed the filter button on the "monthly summary" tab not working in some cases since the last update.
